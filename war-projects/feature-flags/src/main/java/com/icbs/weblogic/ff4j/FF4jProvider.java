...
public class FF4jProvider {
    ...
    private static void createProperties() {
        ...
        ff4j.createProperty(new PropertyString("app.version-a-url", "http://localhost:8083/version-a/", "URL de la versión A"));
        
        // Propiedad 7: URL de la versión B
        ff4j.createProperty(new PropertyString("app.version-b-url", "http://localhost:8083/version-b/", "URL de la versión B"));
    }
