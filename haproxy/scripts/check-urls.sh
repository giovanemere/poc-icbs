...
# Cuando se ejecuta desde dentro del contenedor HAProxy, no podemos usar docker ps
# Así que verificamos si los puertos están abiertos
...
# HAProxy siempre está en ejecución si este script se ejecuta desde el contenedor HAProxy
